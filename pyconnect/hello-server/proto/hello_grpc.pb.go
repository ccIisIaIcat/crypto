...
type SayHelloClient interface {
	SatHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *sayHelloClient) SatHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/SayHello/SatHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SayHelloServer interface {
	SatHello(context.Context, *HelloRequest) (*HelloResponse, error)
...
func (UnimplementedSayHelloServer) SatHello(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _SayHello_SatHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SayHelloServer).SatHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/SayHello/SatHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayHelloServer).SatHello(ctx, req.(*HelloRequest))
	}
...
var SayHello_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SatHello",
			Handler:    _SayHello_SatHello_Handler,
		},
	},
