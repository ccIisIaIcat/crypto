...
class strategyKnifeEth1(strategyBasic.strategy):
    ret = [] # 对数收益率绝对值
    ema = [] # EMA均线
    signal = [] # 生成信号
    len_ = 12 # ema均线长度
    ...
    bar_list = TU.BarinfoArray(Insid="ETH-USDT-SWAP",max_length=60*24*2)
    bar_day_list = TU.BarinfoArray(Insid="ETH-USDT-SWAP")
    ...
    def LoadData(self):
        TU.Load1MBarFromLocalMysql(self,"root","","crypto_swap","ETH-USDT-SWAP",23*60)
        pass
...
if __name__ == '__main__':
    ...
    # 策略名
    my_conf.strategyname = "knifeETH2"
    # bar相关
    ...
    ############################################
    datagather = strategyKnifeEth1(my_conf)
    datagather.Start()
    pyserver.NeverStop()
